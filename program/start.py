            ...
            [
                [
                    InlineKeyboardButton(
                        "• نـصـب بـوتك مـن هـنا •", url="https://t.me/QQQLO",
                    )
                ],
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/2e08e1a08858d2ea98a40.jpg ",
        caption=f"""اهلا وسهلا بك في سورس مميزات السورس قويه وفريده يمكنك امتلاك بوت كامل حقوقك قوم بمراسلة مطور السورس""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("قناة السورس الرسمية", url=f"https://t.me/QQQLO"),
            ],
            [
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton("♡اضف البوت الى مجموعتك♡", url=f"https://t.me/?startgroup=true"),
            ]
         ]
     )
  )
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("مطور السورس", url=f"https://t.me/QQQLO"),
            ],
            [
                InlineKeyboardButton(
